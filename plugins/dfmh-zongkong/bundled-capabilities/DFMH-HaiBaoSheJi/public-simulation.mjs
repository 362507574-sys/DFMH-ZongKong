...
if(contract.repoName!=='DFMH-HaiBaoSheJi'||contract.fullSystemEquivalent!==false||contract.simulationLevel!=='standalone-contract') throw new Error('Public package contract mismatch');
...
console.log('PASS: DFMH-HaiBaoSheJi standalone public contract simulation; fullSystemEquivalent=false; maxRelativePathLength='+longest.length);
