...
if(contract.repoName!=='DFMH-TaoBaoTaoTuSheJi'||contract.fullSystemEquivalent!==false||contract.simulationLevel!=='standalone-contract') throw new Error('Public package contract mismatch');
...
console.log('PASS: DFMH-TaoBaoTaoTuSheJi standalone public contract simulation; fullSystemEquivalent=false; maxRelativePathLength='+longest.length);
