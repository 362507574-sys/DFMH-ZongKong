...
const skillsRoot=path.join(root,'organizations','ai-growth-strategist','skills');
...
if(manifest.repoName!=='DFMH-ZengZhangZhanLueGuan'||manifest.organizationId!=='ai-growth-strategist') throw new Error('Package manifest binding mismatch');
console.log('PASS: DFMH-ZengZhangZhanLueGuan package integrity; skills=3');
