...
if(contract.repoName!=='DFMH-ZengZhangZhanLueGuan'||contract.fullSystemEquivalent!==false||contract.simulationLevel!=='standalone-contract') throw new Error('Public package contract mismatch');
...
console.log('PASS: DFMH-ZengZhangZhanLueGuan standalone public contract simulation; fullSystemEquivalent=false; maxRelativePathLength='+longest.length);
