...
if(contract.repoName!=='DFMH-ChengJiaoGuan'||contract.fullSystemEquivalent!==false||contract.simulationLevel!=='standalone-contract') throw new Error('Public package contract mismatch');
...
console.log('PASS: DFMH-ChengJiaoGuan standalone public contract simulation; fullSystemEquivalent=false; maxRelativePathLength='+longest.length);
