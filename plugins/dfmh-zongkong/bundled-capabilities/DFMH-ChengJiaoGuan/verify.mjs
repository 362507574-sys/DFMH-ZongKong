...
const skillsRoot=path.join(root,'organizations','ai-deal-officer','skills');
...
if(manifest.repoName!=='DFMH-ChengJiaoGuan'||manifest.organizationId!=='ai-deal-officer') throw new Error('Package manifest binding mismatch');
console.log('PASS: DFMH-ChengJiaoGuan package integrity; skills=3');
