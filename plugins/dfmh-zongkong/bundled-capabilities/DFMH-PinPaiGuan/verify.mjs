...
const skillsRoot=path.join(root,'organizations','ai-brand-officer','skills');
...
if(manifest.repoName!=='DFMH-PinPaiGuan'||manifest.organizationId!=='ai-brand-officer') throw new Error('Package manifest binding mismatch');
console.log('PASS: DFMH-PinPaiGuan package integrity; skills=3');
